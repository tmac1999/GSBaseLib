...
public class GSHttpLoggingInterceptor implements Interceptor {
    private static final Charset UTF8 = Charset.forName("UTF-8");
    private volatile GSHttpLoggingInterceptor.Level printLevel;
    private java.util.logging.Level colorLevel;
    private Logger logger;

    public GSHttpLoggingInterceptor(String tag) {
        this.printLevel = GSHttpLoggingInterceptor.Level.NONE;
        //this.logger = Logger.getLogger(tag);
    }

    public void setPrintLevel(GSHttpLoggingInterceptor.Level level) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if(this.printLevel == GSHttpLoggingInterceptor.Level.NONE) {
    ...
    private void logForRequest(Request request, Connection connection) throws IOException {
        boolean logBody = this.printLevel == GSHttpLoggingInterceptor.Level.BODY;
        boolean logHeaders = this.printLevel == GSHttpLoggingInterceptor.Level.BODY || this.printLevel == GSHttpLoggingInterceptor.Level.HEADERS;
            ...
            if(logHeaders) {
                ...
                if(logBody && HttpHeaders.hasBody(clone)) {
                    ...
                    if(isPlaintext(responseBody.contentType())) {
                        ...
                        //this.log("\tbody:" + body);
                        LogUtil.i("url---->"+response.request().url());
                        BeautifulLogUtils.json(body);
    ...
    private void bodyToString(Request request) {
        try {
            ...
            BeautifulLogUtils.json(request.url()+"\n---->"+buffer.readString(charset));
